            ...
            bool debugmode = false)
        {
            return new Action<Image<Gray , byte> , Image<Bgr , byte>>( (baseimg , colorimg) =>
            {
                try
                {
                    ...
                    //color_visual_img2.Save( TestFileSavePath.BasePath + "\\Aftercntr.bmp" );
            ...
            return  (j , i , yps , xps , boxlist, centerlist) =>
                    {
                        ...
                        for ( int k = 0 ; k < boxlist.Count ; k++ )
                        {
                            ...
                            if ( InBox( yps , xps ) )
                            {
                               ...
                               //new CircleF().Map( cirp => cirp.Center = new System.Drawing.PointF(
                               //                             ( float ) ( boxlist[k].X + boxlist[k].Width / 2 )
                               //                             , ( float ) ( boxlist[k].Y + boxlist[k].Height / 2 ) ) )
                               //             .Act( cirp => color_visual_img.Draw( cirp , new Bgr( 255 , 153 , 102 ) , 1 ) );
                                break;
                            }
                        }
                        if ( isFail )
