...
namespace WaferandChipProcessing
{
    ...
    public partial class EpiCore
    {
        ...
        public async void EpiProcessing(int resolution )
        {
            try
            {
                ...
                var dfInfoDic = EpiGrayImgDic.ToDictionary(
                                             ...
                                             .ToDictionary(
                                                 dic => dic.Key
                                               , dic =>
                                                            dic.Value.FindContour(ProcPram.AreaUp, ProcPram.AreaDw))

                                             .ToDictionary(
                                                 dic => dic.Key
                                               , dic => dic.Value.FindDefectInfo());
        ...
        public void SetImageList()
        {
            new FolderBrowserDialog()
                ...
                .Act( ths => ths.SelectedPath = @"D:\03JobPro\2017\08_SVC\Image\sv_4inch_4micro" )// for test
                .Act( ofd =>
                        {
